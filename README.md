...
Compressed database, block number = `0x1b5a3d2`.
...
- mainnet: [chaindata-0x1b5a3d2.tar.zst](https://pub-3cca138de6c349f8afe5f6635f9f6f81.r2.dev/data/chaindata-0x1b5a3d2.tar.zst)
