# ronin-snapshot
Compressed database, block number = `0xaad166`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xaad166.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xaad166.md5
md5sum -c checksum-0xaad166.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xaad166.tar
 ```
