# ronin-snapshot
Compressed database, block number = `0xc68073`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xc68073.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xc68073.md5
md5sum -c checksum-0xc68073.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xc68073.tar
 ```
