# ronin-snapshot
Compressed database, block number = `0xa51b25`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xa51b25.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xa51b25.md5
md5sum -c checksum-0xa51b25.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xa51b25.tar
 ```
