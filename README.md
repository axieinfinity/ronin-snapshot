# ronin-snapshot
Compressed database, block number = `0xc4be73`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xc4be73.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xc4be73.md5
md5sum -c checksum-0xc4be73.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xc4be73.tar
 ```
