# ronin-snapshot
Compressed database, block number = `0xfd3942`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xfd3942.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xfd3942.md5
md5sum -c checksum-0xfd3942.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xfd3942.tar
 ```
