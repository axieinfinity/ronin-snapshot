# ronin-snapshot
Compressed database, block number = `0x1493ede`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x1493ede.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x1493ede.md5
md5sum -c checksum-0x1493ede.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x1493ede.tar
 ```
