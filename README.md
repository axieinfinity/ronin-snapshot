# ronin-snapshot
Compressed database, block number = `0xdb27ec`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xdb27ec.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xdb27ec.md5
md5sum -c checksum-0xdb27ec.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xdb27ec.tar
 ```
