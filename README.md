# ronin-snapshot
Compressed database, block number = `0xa5fc22`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xa5fc22.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xa5fc22.md5
md5sum -c checksum-0xa5fc22.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xa5fc22.tar
 ```
