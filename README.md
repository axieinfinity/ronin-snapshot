# ronin-snapshot
Compressed database, block number = `0x194b6e5`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x194b6e5.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x194b6e5.md5
md5sum -c checksum-0x194b6e5.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x194b6e5.tar
 ```
