# ronin-snapshot
Compressed database, block number = `0xb55d5b`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xb55d5b.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xb55d5b.md5
md5sum -c checksum-0xb55d5b.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xb55d5b.tar
 ```
