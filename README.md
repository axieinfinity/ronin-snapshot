# ronin-snapshot
Compressed database, block number = `0x180f177`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x180f177.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x180f177.md5
md5sum -c checksum-0x180f177.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x180f177.tar
 ```
