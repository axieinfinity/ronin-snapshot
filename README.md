# ronin-snapshot
Compressed database, block number = `0x99d72c`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x99d72c.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x99d72c.md5
md5sum -c checksum-0x99d72c.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x99d72c.tar
 ```
