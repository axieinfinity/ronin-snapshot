# ronin-snapshot
Compressed database, block number = `0xb8e159`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xb8e159.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xb8e159.md5
md5sum -c checksum-0xb8e159.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xb8e159.tar
 ```
