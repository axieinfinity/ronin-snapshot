# ronin-snapshot
Compressed database, block number = `0x186a7f5`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x186a7f5.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x186a7f5.md5
md5sum -c checksum-0x186a7f5.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x186a7f5.tar
 ```
