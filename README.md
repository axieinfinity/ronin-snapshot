# ronin-snapshot
Compressed database, block number = `0xfe89a0`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xfe89a0.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xfe89a0.md5
md5sum -c checksum-0xfe89a0.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xfe89a0.tar
 ```
