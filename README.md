# ronin-snapshot
Compressed database, block number = `0xaf3661`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xaf3661.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xaf3661.md5
md5sum -c checksum-0xaf3661.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xaf3661.tar
 ```
