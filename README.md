# ronin-snapshot
Compressed database, block number = `0xe4c471`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xe4c471.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xe4c471.md5
md5sum -c checksum-0xe4c471.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xe4c471.tar
 ```
