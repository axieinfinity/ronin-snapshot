# ronin-snapshot
Compressed database, block number = `0xfe1988`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xfe1988.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xfe1988.md5
md5sum -c checksum-0xfe1988.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xfe1988.tar
 ```
