# ronin-snapshot
Compressed database, block number = `0xe5a56e`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xe5a56e.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xe5a56e.md5
md5sum -c checksum-0xe5a56e.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xe5a56e.tar
 ```
