# ronin-snapshot
Compressed database, block number = `0xeded27`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xeded27.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xeded27.md5
md5sum -c checksum-0xeded27.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xeded27.tar
 ```
