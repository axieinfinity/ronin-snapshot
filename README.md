# ronin-snapshot
Compressed database, block number = `0xd2ce6d`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xd2ce6d.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xd2ce6d.md5
md5sum -c checksum-0xd2ce6d.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xd2ce6d.tar
 ```
