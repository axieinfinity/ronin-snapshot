# ronin-snapshot
Compressed database, block number = `0x108f4ec`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x108f4ec.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x108f4ec.md5
md5sum -c checksum-0x108f4ec.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x108f4ec.tar
 ```
