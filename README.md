# ronin-snapshot
Compressed database, block number = `0xbf7875`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xbf7875.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xbf7875.md5
md5sum -c checksum-0xbf7875.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xbf7875.tar
 ```
