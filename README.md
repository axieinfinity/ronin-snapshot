# ronin-snapshot
Compressed database, block number = `0xfda973`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xfda973.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xfda973.md5
md5sum -c checksum-0xfda973.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xfda973.tar
 ```
