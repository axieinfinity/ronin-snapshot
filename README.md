# ronin-snapshot
Compressed database, block number = `0x133e89c`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x133e89c.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x133e89c.md5
md5sum -c checksum-0x133e89c.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x133e89c.tar
 ```
