# ronin-snapshot
Compressed database, block number = `0xe93d09`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xe93d09.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xe93d09.md5
md5sum -c checksum-0xe93d09.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xe93d09.tar
 ```
