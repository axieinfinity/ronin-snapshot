# ronin-snapshot
Compressed database, block number = `0xbcd577`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xbcd577.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xbcd577.md5
md5sum -c checksum-0xbcd577.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xbcd577.tar
 ```
