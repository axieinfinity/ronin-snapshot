# ronin-snapshot
Compressed database, block number = `0xf2b6ef`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xf2b6ef.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xf2b6ef.md5
md5sum -c checksum-0xf2b6ef.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xf2b6ef.tar
 ```
