# ronin-snapshot
Compressed database, block number = `0xf0159a`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xf0159a.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xf0159a.md5
md5sum -c checksum-0xf0159a.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xf0159a.tar
 ```
