# ronin-snapshot
Compressed database, block number = `0xa82e72`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xa82e72.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xa82e72.md5
md5sum -c checksum-0xa82e72.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xa82e72.tar
 ```
