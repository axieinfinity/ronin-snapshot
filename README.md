# ronin-snapshot
Compressed database, block number = `0xac9362`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xac9362.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xac9362.md5
md5sum -c checksum-0xac9362.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xac9362.tar
 ```
