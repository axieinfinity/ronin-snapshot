# ronin-snapshot
Compressed database, block number = `0x11115fc`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x11115fc.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x11115fc.md5
md5sum -c checksum-0x11115fc.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x11115fc.tar
 ```
