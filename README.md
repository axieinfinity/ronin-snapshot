# ronin-snapshot
Compressed database, block number = `0xbe26f5`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xbe26f5.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xbe26f5.md5
md5sum -c checksum-0xbe26f5.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xbe26f5.tar
 ```
