# ronin-snapshot
Compressed database, block number = `0x83e6de`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x83e6de.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x83e6de.md5
md5sum -c checksum-0x83e6de.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x83e6de.tar
 ```
