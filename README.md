# ronin-snapshot
Compressed database, block number = `0x13a76de`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0x13a76de.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0x13a76de.md5
md5sum -c checksum-0x13a76de.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0x13a76de.tar
 ```
