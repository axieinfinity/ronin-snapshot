# ronin-snapshot
Compressed database, block number = `0xf63aea`.
...
```shell
curl -O -L -k https://storage.googleapis.com/chaindata/chaindata-0xf63aea.tar
curl -O -L -k https://storage.googleapis.com/chaindata/checksum-0xf63aea.md5
md5sum -c checksum-0xf63aea.md5
```
2. Uncompress downloaded files:
```shell
tar -xvf chaindata-0xf63aea.tar
 ```
